...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('console.command.about' => function (): \Symfony\Bundle\FrameworkBundle\Command\AboutCommand {
    ...
    return ($this->privates['maker.auto_command.make_crud'] ?? $this->load(__DIR__.'/getMaker_AutoCommand_MakeCrudService.php'));
    ...
    return ($this->privates['maker.auto_command.make_fixtures'] ?? $this->load(__DIR__.'/getMaker_AutoCommand_MakeFixturesService.php'));
    ...
    return ($this->privates['maker.auto_command.make_migration'] ?? $this->load(__DIR__.'/getMaker_AutoCommand_MakeMigrationService.php'));
